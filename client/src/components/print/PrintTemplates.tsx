          ...
          <div className="col-span-5 text-right space-y-4">
            <div className="bg-slate-50 p-4 rounded-lg border border-slate-100 space-y-2">
              <table className="w-full text-[11px] leading-relaxed">
                <tbody>
                  <tr>
                    <td className="text-slate-500 py-1 text-left">Taxable Subtotal</td>
                  ...
                  <tr className="font-bold text-[14px] text-slate-900 border-t border-slate-200 pt-2">
                    <td className="py-2 text-slate-950 font-bold text-left">Grand Total</td>
          ...
          <table className="w-full text-[11px]">
            <tbody>
              <tr>
                ...
                <td className="text-right font-medium text-slate-950">{invoice.date}</td>
              </tr>
              {invoice.due_date && (
                <tr>
    ...
    <div className="w-[794px] min-h-[1080px] bg-white p-10 print:p-0 mx-auto font-sans-premium text-[12px] leading-relaxed text-slate-800 border border-slate-200 print:border-0" style={{ boxSizing: 'border-box' }}>
      ...
      <div className="grid grid-cols-2 gap-8 mb-8 pb-6 border-b border-slate-100">
        <div>
          ...
          <div className="text-[13px] font-bold text-slate-950">{customer.name}</div>
          ...
          <table className="w-full text-[11px] leading-relaxed">
            <tbody>
              ...
              {Math.abs(summary.round_off) > 0.001 && (
                <tr>
                  <td className="py-1 text-slate-400 text-left font-medium">Round Off</td>
                  <td className="py-1 font-mono-premium text-slate-505">₹{fmt(summary.round_off)}</td>
                </tr>
              )}
    ...
    <div className="w-[794px] min-h-[1080px] bg-white p-8 print:p-0 mx-auto font-sans-premium text-[12px] leading-relaxed text-slate-800 border border-slate-200 print:border-0" style={{ boxSizing: 'border-box' }}>
      ...
      <div className="grid grid-cols-12 gap-8 mb-4">
        <div className="col-span-7 space-y-4">
          ...
          {company.bank_name && (
            <div className="p-3 border-l-2 border-green-600 bg-green-50/10 rounded-r-lg space-y-1 text-[10px] text-slate-650">
    ...
    <div className="w-[794px] min-h-[1080px] bg-white p-8 print:p-0 mx-auto font-sans-premium text-[12px] leading-relaxed text-slate-800 border border-slate-200 print:border-0" style={{ boxSizing: 'border-box' }}>
      ...
      <div className="grid grid-cols-12 gap-8 mb-4">
        <div className="col-span-7 space-y-4">
          ...
          {company.bank_name && (
            <div className="p-3 border border-slate-100 bg-slate-50 rounded-xl space-y-1 text-[10px] text-slate-650">
